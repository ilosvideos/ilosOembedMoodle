 ...
 * @copyright 2012 Matthew Cannings; modified 2015 by Microsoft, Inc.; modified 2018 vidgrid Co
 ...
 */
function xmldb_filter_vidgrid_oembed_install() {
    global $CFG;

    filter_set_global_state('filter/vidgrid_oembed', TEXTFILTER_ON);
}
